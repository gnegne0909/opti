...
def _page_user_detail(user, logs, alerts, login_hist, notes, remote_hist, geo, msg, admin_user, admin_role):
    ...
    def _hw_val(v):
        ...
        return v
    hw_items = [
        ("💻 OS",        _hw_val(u.get("os_info"))),
        ("🖥 CPU",       _hw_val(u.get("cpu_info"))),
        ("🎮 GPU",       _hw_val(u.get("gpu_info"))),
        ("💾 RAM",       _hw_val(u.get("ram_info"))),
        ("🔌 Carte mère",_hw_val(u.get("motherboard_info"))),
        ("💿 Stockage",  _hw_val(u.get("disk_info"))),
    ]
