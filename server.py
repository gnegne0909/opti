...
.pc-p{{border-color:rgba(255,61,0,.25);background:linear-gradient(135deg,rgba(56,189,248,.04),rgba(255,109,0,.02))}}
...
.chk-p{{background:rgba(56,189,248,.12);border:1px solid rgba(255,61,0,.25);color:var(--accent)}}
...
.ck-p{{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;
  border-radius:6px;background:rgba(56,189,248,.12);border:1px solid rgba(255,61,0,.25);
