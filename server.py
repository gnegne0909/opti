...
<nav class="nav">
  <div class="nav-inner">
    ...
    <div class="nav-actions">
      ...
      <a href="/admin/login" class="btn btn-outline btn-sm" style="border-color:#00ff88;color:#00ff88" title="Panel Admin">⚙️</a>
      <a href="/admin/login?next=reseller" class="btn btn-outline btn-sm" style="border-color:#7c5cbf;color:#a370f7" title="Panel Revendeur">🤝</a>
    </div>
...
<div class="nav-mobile" id="nav-mobile">
  ...
  <div class="nav-m-btns">
    ...
    <a href="/admin/login" class="btn btn-outline btn-sm" style="flex:1;border-color:#00ff88;color:#00ff88">⚙️ Admin</a>
    <a href="/admin/login?next=reseller" class="btn btn-outline btn-sm" style="flex:1;border-color:#7c5cbf;color:#a370f7">🤝 Revendeur</a>
  </div>
</div>"""
...
<footer>
  ...
  <div class="links">
    ...
    <a href="/admin/login" style="color:#00ff88">⚙️ Panel Admin</a>
    <a href="/admin/login?next=reseller" style="color:#a370f7">🤝 Panel Revendeur</a>
  </div>
