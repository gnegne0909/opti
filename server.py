...
<div class="card">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:6px">
    <form method="POST" action="/admin/user/{user['username']}/action" id="frm-action" style="display:flex;flex-wrap:wrap;gap:6px">
    ...
    <form method="POST" action="/admin/ips/add" style="display:flex;gap:6px">
