...
def _page_addons(addon_keys, stats, admin_user, admin_role):
    # Uniquement les addons présents dans l'optimisateur
    ADDON_META = {
        "crosshair":     ("🎯", "Crosshair Overlay",        "PRO libre"),
        "fps_counter":   ("📊", "FPS Counter",              "PRO gratuit"),
        "vibrance":      ("🎨", "Filtre Couleur / Vibrance", "PRO gratuit"),
        "ram_cleaner":   ("🧹", "RAM Cleaner Auto",         "PRO gratuit"),
        "overclock":     ("⚡", "Overclock CPU/GPU",         "PRO libre"),
        "antilag":       ("🌐", "Anti-Lag Réseau Pro",       "PRO libre"),
        "process_boost": ("🚀", "Process Priority Booster",  "PRO gratuit"),
    }
    stat_cards = ""
...
def _page_keys(keys, addon_keys, admin_user, admin_role):
    ...
    # Uniquement les 7 addons présents dans l'optimisateur
