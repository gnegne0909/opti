...
:root{--bg:#050507;--card:#0c0c10;--card2:#111116;--border:#1a1a24;
  --accent:#ff3d00;--accent2:#ff6d00;--accent-d:#1f0600;
  --green:#00e5a0;--red:#ef4444;--text:#f5f5fa;--text2:#7a7a96;}
*{box-sizing:border-box;margin:0;padding:0}
body{font-family:'Exo 2',system-ui,sans-serif;background:var(--bg);color:var(--text);
  display:flex;align-items:center;justify-content:center;min-height:100vh;
  background:radial-gradient(ellipse 60% 60% at 50% 0%,rgba(255,61,0,.06),var(--bg) 60%)}
.wrap{width:100%;max-width:400px;padding:16px}
.card{background:var(--card);border:1px solid var(--border);border-radius:10px;padding:36px 30px;
...
.logo-mark{width:56px;height:56px;background:var(--accent-d);border:1px solid rgba(255,61,0,.35);
  border-radius:10px;display:inline-flex;align-items:center;justify-content:center;
  font-family:'Rajdhani',sans-serif;font-size:28px;font-weight:700;color:var(--accent);
  margin-bottom:14px;position:relative;overflow:hidden}
.logo-mark::after{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(255,61,0,.25),transparent)}
.logo h2{font-family:'Rajdhani',sans-serif;font-size:22px;font-weight:700;
  text-transform:uppercase;letter-spacing:.08em;color:var(--text)}
.logo p{color:var(--text2);font-size:12px;margin-top:4px;letter-spacing:.04em}
.alert{padding:10px 14px;border-radius:6px;background:rgba(239,68,68,.08);
  border:1px solid rgba(239,68,68,.2);color:var(--red);font-size:12px;margin-bottom:14px;font-weight:600}
.alert-warn{padding:10px 14px;border-radius:6px;background:rgba(245,158,11,.08);
  border:1px solid rgba(245,158,11,.2);color:#f59e0b;font-size:12px;margin-bottom:14px;font-weight:600}
.fg{margin-bottom:12px}
label{display:block;font-size:10px;font-weight:700;color:var(--text2);margin-bottom:5px;
  text-transform:uppercase;letter-spacing:.08em;font-family:'Rajdhani',sans-serif}
input{width:100%;background:var(--card2);border:1px solid var(--border);border-radius:6px;
  padding:10px 13px;color:var(--text);font-size:14px;outline:none;transition:.12s;font-family:'Exo 2',sans-serif}
input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(255,61,0,.1)}
.btn{width:100%;padding:12px;border-radius:6px;background:linear-gradient(135deg,var(--accent),var(--accent2));
  color:#fff;font-size:14px;font-weight:700;border:none;cursor:pointer;margin-top:6px;
  font-family:'Rajdhani',sans-serif;text-transform:uppercase;letter-spacing:.08em;transition:.12s}
.btn:hover{opacity:.9;transform:translateY(-1px)}
</style></head><body>
<div class="wrap"><div class="card">
  <div class="logo">
    <div class="logo-mark">X</div>
    <h2>Xywez Optimisation</h2>
    <p>ADMIN PANEL v""" + APP_VERSION + """</p>
  </div>
  {% if expired %}<div class="alert-warn">⏱ Session expirée — reconnecte-toi.</div>{% endif %}
  {% if error %}<div class="alert">{{ error }}</div>{% endif %}
  <form method="POST">
    <div class="fg"><label>Identifiant</label><input name="username" placeholder="admin" autofocus></div>
    <div class="fg"><label>Mot de passe</label><input name="password" type="password" placeholder="••••••••"></div>
