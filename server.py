...
*{box-sizing:border-box;margin:0;padding:0}
:root{
  --bg:#07070d;--card:#0f0f1a;--card2:#141420;--border:#1e1e32;
  --text:#eeeef8;--text2:#8888aa;--accent:#6c4fe0;--accent2:#8b6ff0;
  --green:#00e87a;--red:#ff3b5c;--gold:#f5c842;--muted:#3a3a55;
  --nav-h:64px; --radius:14px;
}
html{scroll-behavior:smooth;font-family:'Syne',system-ui,sans-serif}
body{background:var(--bg);color:var(--text);min-height:100vh;overflow-x:hidden}
@import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800;900&family=Space+Grotesk:wght@300;400;500;600;700&display=swap');

/* ── Navigation ── */
.site-nav{position:fixed;top:0;left:0;right:0;height:var(--nav-h);z-index:100;
  background:rgba(7,7,13,.85);backdrop-filter:blur(20px);
  border-bottom:1px solid rgba(108,79,224,.15)}
.nav-inner{max-width:1280px;margin:auto;height:100%;display:flex;align-items:center;padding:0 32px;gap:32px}
.nav-brand{display:flex;align-items:center;gap:10px;text-decoration:none;flex-shrink:0}
.nav-logo{width:34px;height:34px;background:linear-gradient(135deg,var(--accent),#a78bfa);
  border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:16px}
.nav-brand span{font-weight:800;font-size:17px;color:var(--text)}
.nav-links{display:flex;gap:4px;flex:1;justify-content:center}
.nav-link{text-decoration:none;color:var(--text2);font-size:14px;font-weight:500;
  padding:7px 14px;border-radius:8px;transition:.2s}
.nav-link:hover,.nav-active{color:var(--text);background:rgba(255,255,255,.06)}
.nav-actions{display:flex;gap:8px;align-items:center;flex-shrink:0}
.nav-btn{text-decoration:none;padding:7px 16px;border-radius:9px;font-size:13px;font-weight:600;
  transition:.2s;display:inline-flex;align-items:center;gap:5px;white-space:nowrap}
.nav-btn-ghost{border:1px solid rgba(255,255,255,.12);color:var(--text2);background:transparent}
.nav-btn-ghost:hover{border-color:rgba(255,255,255,.3);color:var(--text)}
.nav-btn-primary{background:linear-gradient(135deg,var(--accent),#a78bfa);color:#fff;border:none}
...
.nav-burger span{width:20px;height:2px;background:var(--text2);border-radius:2px;transition:.2s}
.mob-nav{display:none;flex-direction:column;gap:4px;padding:16px;position:fixed;
  top:var(--nav-h);left:0;right:0;background:rgba(7,7,13,.95);backdrop-filter:blur(20px);
  border-bottom:1px solid var(--border);z-index:99}
.mob-nav.open{display:flex}
.mob-link{text-decoration:none;color:var(--text2);padding:10px 16px;border-radius:8px;font-size:14px;font-weight:500}
.mob-link:hover{background:var(--card);color:var(--text)}

/* ── Page wrapper ── */
.page{padding-top:var(--nav-h)}

/* ── Section ── */
.section{max-width:1280px;margin:auto;padding:80px 32px}
.section-sm{padding:48px 32px}
.section-title{font-size:clamp(28px,4vw,48px);font-weight:900;line-height:1.1;letter-spacing:-.02em}
.section-sub{font-size:17px;color:var(--text2);margin-top:12px;line-height:1.6;max-width:560px}
.tag{display:inline-flex;align-items:center;gap:6px;background:rgba(108,79,224,.15);
  color:var(--accent2);border:1px solid rgba(108,79,224,.25);border-radius:20px;
  padding:5px 14px;font-size:13px;font-weight:600;margin-bottom:16px}

/* ── Buttons ── */
.btn{display:inline-flex;align-items:center;gap:8px;padding:13px 28px;border-radius:12px;
  font-size:15px;font-weight:700;text-decoration:none;transition:.2s;cursor:pointer;border:none}
.btn-primary{background:linear-gradient(135deg,var(--accent),#a78bfa);color:#fff}
.btn-primary:hover{transform:translateY(-2px);box-shadow:0 8px 32px rgba(108,79,224,.4)}
.btn-outline{background:transparent;color:var(--text);border:1px solid var(--border)}
.btn-outline:hover{border-color:var(--accent2);color:var(--accent2)}
.btn-ghost{background:rgba(255,255,255,.05);color:var(--text2)}
.btn-ghost:hover{background:rgba(255,255,255,.1);color:var(--text)}
.btn-green{background:linear-gradient(135deg,#00c853,#00e87a);color:#000}
...
.card-glow{border-color:rgba(108,79,224,.3);box-shadow:0 0 40px rgba(108,79,224,.08)}
.card-green{border-color:rgba(0,232,122,.25)}
.card:hover{border-color:rgba(255,255,255,.12)}
.glass{background:rgba(15,15,26,.7);backdrop-filter:blur(20px)}
...
@media(max-width:768px){.grid-2,.grid-3,.grid-4{grid-template-columns:1fr}.nav-links,.nav-actions .nav-btn-ghost:not(:last-child){display:none}.nav-burger{display:flex}.section{padding:60px 20px}}
...
.hero-glow{position:absolute;width:600px;height:600px;background:radial-gradient(circle,rgba(108,79,224,.25),transparent 70%);
  top:50%;left:50%;transform:translate(-50%,-50%);animation:glow-pulse 4s ease-in-out infinite}
.hero-grid{position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.03) 1px,transparent 1px),
...
.hero-badge{display:inline-flex;align-items:center;gap:8px;background:rgba(108,79,224,.12);
  color:var(--accent2);border:1px solid rgba(108,79,224,.3);border-radius:20px;
  padding:6px 16px;font-size:13px;font-weight:600;margin-bottom:28px}
.hero-title{font-size:clamp(38px,6vw,76px);font-weight:900;line-height:1.0;letter-spacing:-.03em}
.hero-title span{background:linear-gradient(135deg,var(--accent),#a78bfa,#60a5fa);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
.hero-sub{font-size:clamp(16px,2vw,20px);color:var(--text2);margin:20px auto;max-width:600px;line-height:1.6;font-family:'Space Grotesk',sans-serif}
.hero-btns{display:flex;gap:16px;justify-content:center;flex-wrap:wrap;margin-top:40px}
.hero-stats{display:flex;gap:40px;justify-content:center;flex-wrap:wrap;margin-top:56px;padding-top:40px;border-top:1px solid var(--border)}
.hero-stat-n{font-size:32px;font-weight:900;color:var(--text)}
.hero-stat-l{font-size:13px;color:var(--text2);margin-top:2px}

/* ── Features ── */
.feat-card{background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:28px;transition:.25s}
.feat-card:hover{border-color:rgba(108,79,224,.4);transform:translateY(-4px);box-shadow:0 16px 40px rgba(0,0,0,.4)}
...
.feat-desc{font-size:14px;color:var(--text2);line-height:1.6}

/* ── Pricing ── */
.plan-card{background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:32px;position:relative;transition:.25s}
.plan-card:hover{border-color:rgba(108,79,224,.3);transform:translateY(-4px)}
.plan-card.featured{border-color:rgba(108,79,224,.5);background:linear-gradient(160deg,rgba(108,79,224,.08),var(--card))}
.plan-badge-top{position:absolute;top:-12px;left:50%;transform:translateX(-50%);
  ...
  padding:3px 16px;border-radius:20px;font-size:12px;font-weight:700}
.plan-price{font-size:52px;font-weight:900;line-height:1;letter-spacing:-.03em}
.plan-price sup{font-size:22px;font-weight:700;vertical-align:top;margin-top:10px}
.plan-price-period{font-size:15px;color:var(--text2);margin-top:4px}
.plan-features{list-style:none;margin:24px 0;display:flex;flex-direction:column;gap:10px}
.plan-features li{display:flex;align-items:flex-start;gap:10px;font-size:14px;color:var(--text2)}
...
.review-author{font-size:14px;font-weight:600;display:flex;align-items:center;gap:8px}
.review-avatar{width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,var(--accent),#a78bfa);
...
.faq-q{padding:18px 22px;font-size:15px;font-weight:600;cursor:pointer;display:flex;justify-content:space-between;align-items:center;transition:.2s}
.faq-q:hover{background:var(--card2)}
.faq-a{padding:0 22px;max-height:0;overflow:hidden;transition:.3s;color:var(--text2);font-size:14px;line-height:1.7}
.faq-item.open .faq-a{max-height:300px;padding:0 22px 18px}
.faq-item.open .faq-arrow{transform:rotate(180deg)}
.faq-arrow{transition:.3s;color:var(--text2)}

/* ── Footer ── */
.site-footer{background:var(--card);border-top:1px solid var(--border);margin-top:80px}
.footer-inner{max-width:1280px;margin:auto;padding:56px 32px;display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:40px}
.footer-brand p{font-size:14px;color:var(--text2);margin:10px 0 20px;line-height:1.6;max-width:280px}
.footer-logo{font-size:20px;font-weight:900;margin-bottom:4px}
.footer-socials{display:flex;gap:8px;flex-wrap:wrap}
.footer-social-btn{background:var(--card2);border:1px solid var(--border);color:var(--text2);
  padding:7px 16px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:500;transition:.2s}
.footer-social-btn:hover{border-color:var(--accent2);color:var(--accent2)}
.footer-col-title{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:var(--muted);margin-bottom:14px}
.footer-col{display:flex;flex-direction:column;gap:8px}
.footer-col a{text-decoration:none;color:var(--text2);font-size:14px;transition:.15s}
.footer-col a:hover{color:var(--text)}
.footer-bottom{max-width:1280px;margin:auto;padding:20px 32px;border-top:1px solid var(--border);
  display:flex;justify-content:space-between;align-items:center;font-size:13px;color:var(--muted)}
@media(max-width:900px){.footer-inner{grid-template-columns:1fr 1fr}.footer-col:last-child{display:none}}
@media(max-width:600px){.footer-inner{grid-template-columns:1fr}.footer-bottom{flex-direction:column;gap:8px;text-align:center}}

/* ── Table ── */
.table{width:100%;border-collapse:collapse;font-size:14px}
.table th{text-align:left;padding:10px 16px;color:var(--text2);font-weight:600;font-size:12px;text-transform:uppercase;letter-spacing:.06em;border-bottom:1px solid var(--border)}
.table td{padding:12px 16px;border-bottom:1px solid rgba(255,255,255,.04)}
...
.form-group input,.form-group select,.form-group textarea{
  ...
  padding:10px 14px;border-radius:9px;font-size:14px;outline:none;transition:.2s;font-family:inherit}
...
.b-green{background:rgba(0,232,122,.1);color:var(--green);border:1px solid rgba(0,232,122,.2)}
.b-red{background:rgba(255,59,92,.1);color:var(--red);border:1px solid rgba(255,59,92,.2)}
.b-yellow{background:rgba(245,200,66,.1);color:var(--gold);border:1px solid rgba(245,200,66,.2)}
.b-purple{background:rgba(108,79,224,.1);color:var(--accent2);border:1px solid rgba(108,79,224,.2)}
...
.text-gradient{background:linear-gradient(135deg,var(--accent),#a78bfa,#60a5fa);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
...
def _site_nav(active="home"):
    ...
    for label, href, key in links:
        active_class = "nav-active" if active == key else ""
        items += f'<a href="{href}" class="nav-link {active_class}">{label}</a>'
        mob   += f'<a href="{href}" class="mob-link">{label}</a>'
    return f"""
<nav class="site-nav">
  <div class="nav-inner">
    ...
    <div class="nav-actions">
      <a href="/client" class="nav-btn nav-btn-ghost">🔐 Client</a>
      <a href="/admin/login?next=reseller" class="nav-btn nav-btn-ghost" style="border-color:rgba(124,92,191,.5);color:#a370f7">🤝 Reseller</a>
      <a href="/admin/login" class="nav-btn nav-btn-ghost" style="border-color:rgba(0,255,136,.3);color:#00ff88">⚙️ Admin</a>
      <a href="/pricing" class="nav-btn nav-btn-primary">Acheter</a>
    </div>
...
<div class="mob-nav" id="mob-nav">
  ...
  <div style="display:flex;flex-direction:column;gap:8px;padding:8px 0 0">
    <a href="/client" class="nav-btn nav-btn-ghost" style="text-align:center">🔐 Espace Client</a>
    <a href="/admin/login?next=reseller" class="nav-btn nav-btn-ghost" style="text-align:center;border-color:rgba(124,92,191,.5);color:#a370f7">🤝 Panel Reseller</a>
    <a href="/admin/login" class="nav-btn nav-btn-ghost" style="text-align:center;border-color:rgba(0,255,136,.3);color:#00ff88">⚙️ Panel Admin</a>
    <a href="/pricing" class="nav-btn nav-btn-primary" style="text-align:center">Acheter maintenant</a>
  </div>
</div>"""
...
<footer class="site-footer">
  <div class="footer-inner">
    <div class="footer-brand">
      <div class="footer-logo">⚡ {site_title}</div>
      <p>Le logiciel d'optimisation Windows le plus avancé pour les gamers.</p>
      <div class="footer-socials">
        <a href="{discord_link}" target="_blank" class="footer-social-btn">Discord</a>
        <a href="{SITE_URL}/client" class="footer-social-btn">Espace Client</a>
      </div>
    </div>
  ...
  <div class="footer-bottom">
    <span>© 2025 {site_title} — Tous droits réservés</span>
    <span style="color:var(--muted)">Fait avec ⚡ par Xywez</span>
  </div>
</footer>
<div id="chatbot-notif" style="position:fixed;bottom:90px;right:24px;background:linear-gradient(135deg,var(--accent),#a78bfa);
  color:#fff;padding:8px 14px;border-radius:12px;font-size:13px;font-weight:600;z-index:998;
  box-shadow:0 4px 16px rgba(108,79,224,.4);animation:glow-pulse 2s infinite;cursor:pointer" onclick="toggleChat()">
  Besoin d'aide ? 💬</div>
<div id="chatbot-widget" style="display:none;position:fixed;bottom:90px;right:24px;width:360px;
  background:var(--card);border:1px solid var(--border);border-radius:20px;
  box-shadow:0 8px 40px rgba(0,0,0,.6);z-index:1000;overflow:hidden;flex-direction:column;max-height:520px">
  <div style="background:linear-gradient(135deg,var(--accent),#a78bfa);padding:16px 20px;display:flex;align-items:center;gap:12px">
    <div style="font-size:28px">🤖</div>
    <div>
      <div style="font-weight:800;font-size:15px;color:#fff">OptBot</div>
  ...
  <div id="chat-messages" style="padding:16px;overflow-y:auto;flex:1;display:flex;flex-direction:column;gap:10px;max-height:360px">
    <div class="bot-msg">Salut ! Je suis OptBot. Comment puis-je t'aider ? 😊</div>
  ...
  <div style="padding:12px 16px;border-top:1px solid var(--border);display:flex;gap:8px">
    ...
    <button onclick="sendMsg()" style="background:linear-gradient(135deg,var(--accent),#a78bfa);border:none;
      border-radius:10px;width:40px;height:40px;cursor:pointer;font-size:18px;color:#fff">➤</button>
  </div>
</div>
<style>
.bot-msg{{background:var(--card2);border-radius:12px 12px 12px 4px;padding:10px 14px;font-size:14px;color:var(--text);line-height:1.6;max-width:90%;white-space:pre-wrap}}
.user-msg{{background:linear-gradient(135deg,var(--accent),#a78bfa);border-radius:12px 12px 4px 12px;padding:10px 14px;font-size:14px;color:#fff;line-height:1.6;max-width:90%;align-self:flex-end}}
.quick-btn{{background:rgba(108,79,224,.12);border:1px solid rgba(108,79,224,.3);color:var(--accent2);border-radius:20px;padding:5px 12px;font-size:12px;cursor:pointer;transition:.2s;white-space:nowrap}}
.quick-btn:hover{{background:rgba(108,79,224,.25)}}
@keyframes glow-pulse{{0%,100%{{transform:scale(1)}}50%{{transform:scale(1.04)}}}}
</style>
<script>
(function(){{
var chatOpen=false;
...
window.sendQuick=function(txt){{document.getElementById('chat-input').value=txt;sendMsg();}};
function sendMsg(){{
  var inp=document.getElementById('chat-input');
  ...
  fetch('/api/chatbot',{{method:'POST',headers:{{'Content-Type':'application/json'}},body:JSON.stringify({{message:msg}})}})
    ...
    .then(function(d){{addMsg(d.response||"Contacte-nous sur Discord !","bot");}})
    .catch(function(){{addMsg("Erreur réseau. Rejoins notre Discord !","bot");}});
}};
window.sendMsg=sendMsg;
function addMsg(text,type){{
  var div=document.createElement('div');div.className=type==='user'?'user-msg':'bot-msg';
...
def site_home():
    ...
    discord_link  = get_site_setting("discord_invite", DISCORD_INVITE)
    site_title    = get_site_setting("site_title", "Xywez Optimisation")
    site_tagline  = get_site_setting("site_tagline", "Domination totale des FPS")
    price_n = SHOP_PRICES["NORMAL"]["price"]
    price_p = SHOP_PRICES["PRO"]["price"]

    # Avis clients depuis DB
    conn_r = get_db()
    reviews_db = conn_r.execute(
        "SELECT * FROM reviews WHERE approved=1 ORDER BY created_at DESC LIMIT 6"
    ).fetchall() if "reviews" in [r[0] for r in conn_r.execute("SELECT name FROM sqlite_master WHERE type='table'").fetchall()] else []
    conn_r.close()

    # Avis par défaut si vide
    default_reviews = [
        {"author":"SwiftGamer_FR","plan":"PRO","text":"Incroyable ! +35 FPS sur Warzone en 2 minutes. L'overclock auto est dingue.","stars":5,"avatar":"S"},
        {"author":"TechMaster42","plan":"NORMAL","text":"Interface super propre, easy à utiliser. Mon PC démarre 2x plus vite.","stars":5,"avatar":"T"},
        {"author":"NightRaider","plan":"PRO","text":"Le support à distance m'a sauvé la mise. Équipe top, produit 10/10.","stars":5,"avatar":"N"},
        {"author":"FlyingAce99","plan":"NORMAL","text":"Pour 20€ c'est honnêtement le meilleur investissement gaming de l'année.","stars":5,"avatar":"F"},
        {"author":"ProStreamer_X","plan":"PRO","text":"Addons FPS Counter + Vibrance = game changer. Stream parfaitement fluide.","stars":5,"avatar":"P"},
        {"author":"Zeph_ctrl","plan":"PRO","text":"Les presets Ultra Performance sont ouf. Mon old PC fait tourner Fortnite à 144fps.","stars":4,"avatar":"Z"},
    ]
    reviews_list = []
    if reviews_db:
        for r in reviews_db:
            reviews_list.append(dict(r))
    else:
        reviews_list = default_reviews

    def _review(rv):
        stars = "★" * rv.get("stars",5) + "☆" * (5 - rv.get("stars",5))
        plan_b = f'<span class="badge b-purple" style="font-size:11px">{rv.get("plan","?")}</span>' if rv.get("plan") else ""
        av = rv.get("avatar", rv.get("author","?")[0].upper())
        return f"""<div class="review-card animate">
          <div class="review-stars">{stars}</div>
          <p class="review-text">"{rv.get("text","")}"</p>
          <div class="review-author">
            <div class="review-avatar">{av}</div>
            <div>
              <div style="font-weight:700">{rv.get("author","Anonyme")}</div>
              <div style="font-size:12px;color:var(--muted)">{plan_b}</div>
            </div>
          </div>
        </div>"""

    reviews_html = "".join(_review(r) for r in reviews_list)

    features = [
        ("🚀","#6c4fe0","Boost FPS Instantané","Jusqu'à +50% de FPS en quelques secondes grâce à nos tweaks gaming."),
        ("🧹","#059669","Nettoyage Professionnel","Élimine les bloatwares, services inutiles et ralentissements."),
        ("🌐","#0ea5e9","Réseau Ultra-Optimisé","Réduis ta latence jusqu'à -30ms pour les jeux en ligne."),
        ("🔒","#f59e0b","Protection Vie Privée","Bloque la télémétrie Windows et les pubs intrusives."),
        ("🎮","#ec4899","Bibliothèque de 25+ Jeux","Presets spécifiques pour Fortnite, CS2, Valorant, Warzone..."),
        ("⚡","#a78bfa","Tweaks Avancés PRO","HPET, Core Parking, Overclock CPU/GPU sécurisé et bien plus."),
        ("🤖","#10b981","Consultation IA","Analyse ton système et te donne des recommandations personnalisées."),
        ("🛟","#ef4444","Support à Distance","Les admins peuvent accéder à distance pour t'aider en temps réel."),
    ]

    feats_html = ""
    for icon, color, title, desc in features:
        feats_html += f"""<div class="feat-card animate">
          <div class="feat-icon" style="background:{color}22;color:{color}">{icon}</div>
          <div class="feat-title">{title}</div>
          <div class="feat-desc">{desc}</div>
        </div>"""

    page = f"""<!DOCTYPE html><html lang="fr"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<meta name="description" content="{site_tagline} — {site_title}">
<title>{site_title} — Optimiseur Windows Gaming</title>
...
<section class="hero">
  ...
  <div class="hero-content">
    <div class="hero-badge animate">⚡ +5 000 gamers optimisés · Mis à jour quotidiennement</div>
    <h1 class="hero-title animate d1">
      Domine tes<br><span>adversaires</span><br>en FPS
    </h1>
    <p class="hero-sub animate d2">
      WinOptimizer Pro extrait chaque frame et milliseconde de ton PC.
      Setup en 2 minutes. Résultats immédiats.
    </p>
    <div class="hero-btns animate d3">
      <a href="/pricing" class="btn btn-primary" style="padding:15px 36px;font-size:16px">🚀 Commencer maintenant</a>
      <a href="/features" class="btn btn-outline" style="padding:15px 28px;font-size:16px">Voir les fonctionnalités</a>
    </div>
    <div class="hero-stats animate d4">
      <div style="text-align:center">
        <div class="hero-stat-n text-gradient">+97</div>
        <div class="hero-stat-l">Optimisations incluses</div>
      </div>
      <div style="text-align:center">
        <div class="hero-stat-n text-gradient">+50%</div>
        <div class="hero-stat-l">FPS gagnés en moyenne</div>
      </div>
      <div style="text-align:center">
        <div class="hero-stat-n text-gradient">-30ms</div>
        <div class="hero-stat-l">Latence réseau réduite</div>
      </div>
      <div style="text-align:center">
        <div class="hero-stat-n text-gradient">25+</div>
        <div class="hero-stat-l">Jeux supportés</div>
      </div>
    </div>
  </div>
</section>
...
<!-- ── FEATURES ── -->
<section style="background:linear-gradient(180deg,var(--bg) 0%,rgba(108,79,224,.04) 50%,var(--bg) 100%)">
  <div class="section">
    <div style="text-align:center;margin-bottom:56px">
      <div class="tag">⚡ Fonctionnalités</div>
      <h2 class="section-title" style="text-align:center">Tout ce dont tu as besoin<br><span class="text-gradient">pour dominer</span></h2>
      <p class="section-sub" style="text-align:center;margin:16px auto 0">
        Un seul outil, toutes les optimisations. Pas de bloat, pas de compétences requises.
      </p>
    </div>
...
<section>
  <div class="section">
    <div style="text-align:center;margin-bottom:56px">
      ...
      <h2 class="section-title" style="text-align:center">Choisis ton plan<br><span class="text-gradient">à partir de {price_n:.0f}€</span></h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;align-items:start;max-width:960px;margin:auto">

      <!-- NORMAL -->
      <div class="plan-card animate d1">
        <div style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--text2);margin-bottom:8px">Normal</div>
        <div class="plan-price"><sup>€</sup>{price_n:.0f}<span style="font-size:18px;color:var(--text2);font-weight:500"> / vie</span></div>
        <p style="font-size:14px;color:var(--text2);margin:16px 0 24px">Tout ce qu'il faut pour booster ton PC gaming.</p>
        <ul class="plan-features">
          <li>50+ optimisations Windows</li>
          <li>Gaming Pack 25 jeux</li>
          <li>Optimisation réseau</li>
          <li>Protection vie privée</li>
          <li>Mises à jour automatiques</li>
          <li>Espace client personnel</li>
      ...
      <!-- PRO -->
      <div class="plan-card featured animate d2">
        <div class="plan-badge-top">⭐ POPULAIRE</div>
        <div style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--accent2);margin-bottom:8px">Pro</div>
        <div class="plan-price" style="color:var(--accent2)"><sup>€</sup>{price_p:.0f}<span style="font-size:18px;color:var(--text2);font-weight:500"> / vie</span></div>
        <p style="font-size:14px;color:var(--text2);margin:16px 0 24px">La solution complète pour les gamers sérieux.</p>
        <ul class="plan-features">
          <li>Tout ce qui est dans Normal</li>
          <li>47 tweaks gaming avancés</li>
          <li>8 addons gratuits inclus</li>
          <li>Presets Ultra/Streamer/Gaming</li>
          <li>Overclock CPU/GPU sécurisé</li>
          <li>Consultation IA intégrée</li>
          <li>Support à distance</li>
          <li>Accès prioritaire bêta</li>
          <li>Badge PRO sur le Discord</li>
        </ul>
        <a href="{discord_link}" target="_blank" class="btn btn-primary" style="width:100%;justify-content:center">Acheter via Discord →</a>
      </div>

      <!-- RESELLER -->
      <div class="plan-card animate d3">
        <div style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#a370f7;margin-bottom:8px">Reseller</div>
        <div class="plan-price" style="color:#a370f7"><sup>€</sup>60<span style="font-size:18px;color:var(--text2);font-weight:500"> – 100€</span></div>
        <p style="font-size:14px;color:var(--text2);margin:16px 0 24px">Revends WinOptimizer et génère des revenus.</p>
        <ul class="plan-features">
          <li>🥉 Starter 60€ · -15% · 30 crédits</li>
          <li>🥈 Business 80€ · -25% · 80 crédits</li>
          <li>🥇 Elite 100€ · -40% · 200 crédits</li>
          <li>Panel revendeur complet</li>
          <li>Génération de clés NORMAL/PRO</li>
          <li>Gestion de tes clients</li>
          <li>Statistiques de vente</li>
          <li>Support dédié revendeur</li>
        </ul>
        <a href="{discord_link}" target="_blank" class="btn btn-ghost" style="width:100%;justify-content:center;border:1px solid rgba(163,112,247,.3);color:#a370f7">Devenir Revendeur →</a>
      </div>
...
<section>
  <div class="section">
    <div style="text-align:center;margin-bottom:48px">
      <div class="tag">⭐ Avis clients</div>
      <h2 class="section-title" style="text-align:center">Ce qu'ils en pensent</h2>
      <p class="section-sub" style="text-align:center;margin:12px auto 0">Des milliers de gamers ont déjà optimisé leur setup.</p>
    </div>
    <div class="grid-3">{reviews_html}</div>
    <div style="text-align:center;margin-top:32px">
      <a href="/client#review" class="btn btn-ghost btn-sm" style="border:1px solid var(--border)">✍️ Laisser ton avis (espace client)</a>
    </div>
  </div>
</section>
...
<section>
  <div class="section" style="padding-top:0">
    <div style="background:linear-gradient(135deg,rgba(108,79,224,.15),rgba(167,139,250,.08));
      border:1px solid rgba(108,79,224,.3);border-radius:20px;padding:56px 40px;text-align:center">
      <h2 class="section-title" style="text-align:center">Prêt à <span class="text-gradient">dominer</span> ?</h2>
      <p class="section-sub" style="text-align:center;margin:16px auto 32px">
        Rejoins des milliers de gamers qui ont déjà transformé leur setup en arme de compétition.
      </p>
      <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap">
        <a href="/pricing" class="btn btn-primary" style="padding:15px 36px;font-size:16px">🚀 Acheter maintenant</a>
        <a href="{discord_link}" target="_blank" class="btn btn-outline" style="padding:15px 28px;font-size:16px">💬 Rejoindre le Discord</a>
      </div>
    </div>
  </div>
</section>
