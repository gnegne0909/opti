...
:root{
  ...
  --accent:#ff3d00;--accent2:#ff6b00;--accent-g:linear-gradient(135deg,#ff3d00,#ff6b00);
  --green:#00d68f;--red:#ff3366;--blue:#2979ff;--gold:#ffc107;--purple:#7c3aed;
  --text:#f2f2fa;--text2:#7878a0;--muted:#2e2e48;--sidebar:228px;
  --glow:0 0 20px rgba(255,61,0,.18);
}
...
.b-accent{background:rgba(255,61,0,.08);color:var(--accent2);border:1px solid rgba(255,61,0,.18)}
...
.nav-item.active{color:var(--accent2);background:rgba(255,61,0,.06);border-left-color:var(--accent)}
...
.card-glow{border-color:rgba(255,61,0,.2);box-shadow:var(--glow)}
...
.stat-card:hover{border-color:rgba(255,61,0,.25);transform:translateY(-1px)}
...
.table tr:hover td{background:rgba(255,61,0,.02)}
...
.form-group input:focus,.form-group select:focus,.form-group textarea:focus{border-color:var(--accent);box-shadow:0 0 0 2px rgba(255,61,0,.1)}
...
.bar{background:rgba(255,61,0,.45);min-width:6px;transition:.3s}
...
LOGIN_HTML = """<!DOCTYPE html><html lang="fr"><head>\n<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">\n<title>Admin Login</title>\n<style>\n@import url('https://fonts.googleapis.com/css2?family=Rajdhani:wght@700&family=DM+Sans:opsz,wght@9..40,400;9..40,600&display=swap');\n*{box-sizing:border-box;margin:0;padding:0}\nbody{font-family:'DM Sans',sans-serif;background:#06060a;color:#f2f2fa;display:flex;align-items:center;justify-content:center;min-height:100vh;padding:20px}\n.w{width:100%;max-width:380px}.c{background:#0e0e16;border:1px solid #1c1c2e;padding:40px 36px}\n.lm{width:52px;height:52px;background:linear-gradient(135deg,#ff3d00,#ff6b00);display:inline-flex;align-items:center;justify-content:center;font-family:'Rajdhani',sans-serif;font-size:26px;font-weight:700;color:#fff;clip-path:polygon(0 0,calc(100% - 10px) 0,100% 10px,100% 100%,10px 100%,0 calc(100% - 10px))}\n.logo{text-align:center;margin-bottom:32px}.logo h2{font-family:'Rajdhani',sans-serif;font-size:22px;font-weight:700;text-transform:uppercase;margin-top:12px}.logo h2 em{color:#ff3d00;font-style:normal}.logo p{color:#7878a0;font-size:13px;margin-top:4px}\n.al{padding:10px 13px;background:rgba(255,51,102,.08);border:1px solid rgba(255,51,102,.2);color:#ff3366;font-size:13px;margin-bottom:14px}\n.aw{padding:10px 13px;background:rgba(255,193,7,.08);border:1px solid rgba(255,193,7,.2);color:#ffc107;font-size:13px;margin-bottom:14px}\n.fg{margin-bottom:12px}.fg label{display:block;font-size:10px;font-weight:700;color:#7878a0;text-transform:uppercase;letter-spacing:.1em;margin-bottom:5px}\n.fg input{width:100%;background:#13131e;border:1px solid #252540;color:#f2f2fa;padding:10px 13px;font-size:14px;outline:none;font-family:inherit;transition:.15s}\n.fg input:focus{border-color:#ff3d00}\n.btn{width:100%;padding:12px;background:linear-gradient(135deg,#ff3d00,#ff6b00);color:#fff;font-size:14px;font-weight:700;border:none;cursor:pointer;font-family:'Rajdhani',sans-serif;text-transform:uppercase;letter-spacing:.1em;margin-top:6px}\n.btn:hover{filter:brightness(1.1)}\n</style></head><body>\n<div class="w"><div class="c">\n<div class="logo"><div class="lm">X</div>\n<h2><em>X</em>ywez Optimisation</h2>\n<p>Panel d'administration</p></div>\n{% if expired %}<div class="aw">Session expire &mdash; reconnecte-toi.</div>{% endif %}\n{% if error %}<div class="al">{{ error }}</div>{% endif %}\n<form method="POST">\n<div class="fg"><label>Identifiant</label><input name="username" placeholder="username" autofocus></div>\n<div class="fg"><label>Mot de passe</label><input name="password" type="password" placeholder="password"></div>\n<button type="submit" class="btn">Se connecter</button>\n</form></div></div></body></html>"""
...
*{box-sizing:border-box;margin:0;padding:0}
:root{
  --bg:#03040a;--surface:#07091200;--card:#0a0c15;--card2:#0e1020;
  --border:rgba(255,255,255,.06);--border2:rgba(255,255,255,.1);
  --accent:#ff3d00;--accent2:#ff6d00;--accent-d:rgba(255,61,0,.12);
  --gold:#f0b429;--blue:#4d90ff;--green:#00d68f;--purple:#7c5cfc;--red:#ef4444;--cyan:#00d4ff;
  --text:#ecedf5;--text2:#6b7280;--muted:#1e2030;--nav-h:64px;
}
html{scroll-behavior:smooth}
...
.site-nav{position:fixed;top:0;left:0;right:0;height:var(--nav-h);z-index:100;
  background:rgba(3,4,10,.85);backdrop-filter:blur(24px) saturate(1.4);
...
.nav-logo-box{width:32px;height:32px;border-radius:8px;background:var(--accent);
  display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;
  font-size:17px;color:#fff;letter-spacing:.05em}
.nav-logo-name{font-family:'Space Grotesk',sans-serif;font-size:15px;font-weight:700;
...
.nb-ghost:hover{border-color:rgba(255,61,0,.4);color:var(--text)}
.nb-fire{background:var(--accent);color:#fff;border:none;font-weight:700}
.nb-fire:hover{background:var(--accent2);box-shadow:0 4px 20px rgba(255,61,0,.35)}
.nb-admin{border-color:rgba(0,214,143,.2);color:var(--green);background:rgba(0,214,143,.06)}
.nb-res{border-color:rgba(124,92,252,.25);color:#a78bfa;background:rgba(124,92,252,.07)}
...
.mob-nav{display:none;flex-direction:column;gap:3px;padding:14px 16px 18px;position:fixed;
  top:var(--nav-h);left:0;right:0;background:rgba(3,4,10,.97);backdrop-filter:blur(24px);
...
.h-mesh{position:absolute;inset:0;
  background:radial-gradient(ellipse 120% 80% at 50% -10%,rgba(255,61,0,.18) 0%,transparent 60%),
  radial-gradient(ellipse 60% 60% at 80% 80%,rgba(77,144,255,.08) 0%,transparent 50%)}
.h-grid{position:absolute;inset:0;
  background-image:linear-gradient(rgba(255,61,0,.04) 1px,transparent 1px),
...
.h-chip{display:inline-flex;align-items:center;gap:8px;
  background:rgba(255,61,0,.08);color:rgba(255,130,60,1);
  border:1px solid rgba(255,61,0,.2);border-radius:40px;
...
.h-title-accent{color:var(--accent);display:block;
  text-shadow:0 0 60px rgba(255,61,0,.4),0 0 120px rgba(255,61,0,.2)}
...
.h-stat-n{font-family:'Bebas Neue',sans-serif;font-size:42px;color:var(--text);line-height:1;
  background:linear-gradient(135deg,#fff,rgba(255,130,60,.8));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
.sec-label{display:inline-block;font-size:11px;font-weight:700;text-transform:uppercase;
  ...
  border:1px solid rgba(255,61,0,.2);border-radius:40px;padding:4px 14px;margin-bottom:16px;
...
.btn-fire:hover{background:var(--accent2);box-shadow:0 8px 30px rgba(255,61,0,.4)}
.btn-outline{background:transparent;color:var(--text);border:1px solid var(--border2)}
.btn-outline:hover{border-color:rgba(255,61,0,.4);color:var(--accent2)}
.btn-ghost{background:rgba(255,255,255,.05);color:var(--text2);border:1px solid var(--border)}
...
.feat-card::after{content:'';position:absolute;inset:0;border-radius:16px;
  background:radial-gradient(circle at 0% 0%,rgba(255,61,0,.06),transparent 60%);
  opacity:0;transition:opacity .3s}
.feat-card:hover{border-color:rgba(255,61,0,.2);transform:translateY(-3px);box-shadow:0 20px 60px rgba(0,0,0,.5)}
...
.plan-card.featured{border-color:rgba(255,61,0,.3);background:linear-gradient(135deg,rgba(255,61,0,.05),rgba(255,109,0,.03))}
...
.review-card:hover{border-color:rgba(255,61,0,.15);transform:translateY(-2px)}
...
.footer-brand-name{font-family:'Space Grotesk',sans-serif;font-size:20px;font-weight:700;
  text-transform:uppercase;letter-spacing:.1em;margin-bottom:10px;color:var(--text)}
...
.footer-sb:hover{border-color:rgba(255,61,0,.3);color:var(--accent2)}
...
.b-purple{background:rgba(124,92,252,.1);color:#a78bfa;border:1px solid rgba(124,92,252,.2)}
...
.form-group input:focus,.form-group select:focus,.form-group textarea:focus{border-color:rgba(255,61,0,.4)}
...
.faq-item:hover{border-color:rgba(255,61,0,.15)}
...
/* ── CHATBOT ── */
.quick-btn{background:rgba(255,61,0,.08);border:1px solid rgba(255,61,0,.2);color:rgba(255,130,60,1);
...
.quick-btn:hover{background:rgba(255,61,0,.15)}
...
<nav class="site-nav">
  <div class="nav-wrap">
    <a href="/" class="nav-logo">
      ...
      <div class="nav-logo-name"><b>X</b>YWEZ OPT</div>
    </a>
...
<footer class="site-footer">
  <div class="footer-wrap">
    <div>
      <div class="footer-brand-name"><b>X</b>YWEZ OPT</div>
...
<div id="chatbot-notif" style="position:fixed;bottom:88px;right:22px;background:linear-gradient(135deg,var(--accent),var(--accent2));
  color:#fff;padding:7px 14px;border-radius:5px;font-size:12px;font-weight:700;z-index:998;
  box-shadow:0 4px 20px rgba(255,61,0,.4);cursor:pointer;font-family:'Rajdhani',sans-serif;text-transform:uppercase;letter-spacing:.06em;
  animation:gp 2.5s infinite" onclick="toggleChat()">
  Besoin d'aide ? 💬</div>
<div id="chatbot-widget" style="display:none;position:fixed;bottom:88px;right:22px;width:355px;
  background:var(--card);border:1px solid var(--border);border-radius:8px;
  box-shadow:0 16px 60px rgba(0,0,0,.7);z-index:1000;overflow:hidden;flex-direction:column;max-height:510px">
  <div style="background:linear-gradient(135deg,var(--accent),var(--accent2));padding:14px 18px;display:flex;align-items:center;gap:10px">
    ...
    <div>
      <div style="font-family:'Rajdhani',sans-serif;font-weight:700;font-size:15px;color:#fff;text-transform:uppercase;letter-spacing:.06em">XYWEZ BOT</div>
      <div style="font-size:11px;color:rgba(255,255,255,.75)">🟢 En ligne — répond instantanément</div>
    </div>
    <div onclick="toggleChat()" style="margin-left:auto;cursor:pointer;color:rgba(255,255,255,.7);font-size:18px;line-height:1">✕</div>
  </div>
  ...
  <div style="padding:10px 14px;border-top:1px solid var(--border);display:flex;gap:8px;background:var(--card2)">
    <input id="chat-input" placeholder="Tape ta question..." style="flex:1;background:var(--bg);border:1px solid var(--border);
      border-radius:5px;padding:9px 12px;color:var(--text);font-size:13px;outline:none;font-family:'Exo 2',sans-serif"
      onkeydown="if(event.key==='Enter')sendMsg()">
    <button onclick="sendMsg()" style="background:var(--accent);border:none;border-radius:5px;width:38px;height:38px;cursor:pointer;font-size:16px;color:#fff;flex-shrink:0">➤</button>
  </div>
</div>
<style>
.bot-msg{{background:var(--card2);border-radius:5px 5px 5px 2px;padding:9px 12px;font-size:13px;color:var(--text);line-height:1.6;max-width:90%;white-space:pre-wrap}}
.user-msg{{background:var(--accent);border-radius:5px 5px 2px 5px;padding:9px 12px;font-size:13px;color:#fff;line-height:1.6;max-width:90%;align-self:flex-end}}
</style>
<script>
(function(){{
var chatOpen=false;
...
function sendMsg(){{
  ...
  fetch('/api/chatbot',{{method:'POST',headers:{{'Content-Type':'application/json'}},body:JSON.stringify({{message:m}})}})
    .then(r=>r.json()).then(d=>addMsg(d.response||'Contacte-nous sur Discord !','bot'))
    .catch(()=>addMsg('Erreur réseau. Rejoins notre Discord !','bot'));
}};
...
<!-- ░░ FEATURES ░░ -->
<section style="padding:80px 0;background:linear-gradient(180deg,rgba(255,61,0,.03),transparent)">
...
<section style="padding:0 0 80px">
  <div class="section" style="padding-top:0">
    <div style="background:linear-gradient(135deg,rgba(255,61,0,.08),rgba(255,109,0,.04));
      border:1px solid rgba(255,61,0,.2);border-radius:24px;padding:64px 40px;text-align:center;position:relative;overflow:hidden">
      <div style="position:absolute;top:0;left:0;right:0;height:1px;
        background:linear-gradient(90deg,transparent,var(--accent),var(--accent2),transparent)"></div>
      <div style="position:absolute;inset:0;background:radial-gradient(ellipse 60% 60% at 50% 0%,rgba(255,61,0,.12),transparent)"></div>
      <div style="position:relative">
...
<section style="padding:100px 5% 60px;position:relative;overflow:hidden;text-align:center">
  <div style="position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 0%,rgba(255,61,0,.1),transparent);pointer-events:none"></div>
...
<section style="padding:0 0 80px">
  <div class="section" style="padding-top:0">
    <div style="background:linear-gradient(135deg,rgba(255,61,0,.07),rgba(255,109,0,.03));
      border:1px solid rgba(255,61,0,.18);border-radius:24px;padding:56px 40px;text-align:center">
      <div style="position:absolute;top:0;left:0;right:0;height:1px;
...
.pr-mesh{{position:absolute;inset:0;
  background:radial-gradient(ellipse 80% 60% at 10% 20%,rgba(255,61,0,.1),transparent 50%),
...
.pc-p{{border-color:rgba(255,61,0,.25);background:linear-gradient(135deg,rgba(255,61,0,.04),rgba(255,109,0,.02))}}
.pc-p:hover{{box-shadow:0 24px 80px rgba(255,61,0,.2)}}
.pc-topbar{{position:absolute;top:0;left:0;right:0;height:2px}}
.pc-topbar-p{{background:linear-gradient(90deg,transparent,#ff3d00,#ff6d00,transparent)}}
...
.pc-price-p{{background:linear-gradient(135deg,#ff3d00,#ff9500);
  -webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}}
...
.chk-p{{background:rgba(255,61,0,.12);border:1px solid rgba(255,61,0,.25);color:var(--accent)}}
...
.cta-p:hover{{background:var(--accent2);box-shadow:0 8px 40px rgba(255,61,0,.45)}}
...
.ck-p{{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;
  border-radius:6px;background:rgba(255,61,0,.12);border:1px solid rgba(255,61,0,.25);
...
<div class="pr-hero">
  ...
  <h1 style="font-family:'Bebas Neue',sans-serif;font-size:clamp(56px,9vw,110px);line-height:.9;letter-spacing:.02em;color:var(--text);margin-bottom:16px" class="apu du2">
    DES PRIX<br><span style="color:var(--accent);text-shadow:0 0 60px rgba(255,61,0,.4)">ACCESSIBLES</span>
  </h1>
...
:root {
  ...
  --sidebar: 240px;
  --radius:  14px;
  --glow-p:  0 0 40px rgba(124,92,191,.18);
...
body {{ display:flex; align-items:center; justify-content:center; min-height:100vh;
  background: radial-gradient(ellipse at 50% 0%, rgba(124,92,191,.12) 0%, var(--bg) 60%); }}
