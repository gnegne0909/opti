...
# ── Clé secrète — lue depuis variable d'environnement ────────────────────────
# Sur Render : variable MASTER_SECRET dans Environment
# En local   : même valeur que sur Render obligatoirement
_secret_env = os.environ.get("MASTER_SECRET", "WinOpt_k7#Xm2@pQ9_zR4wN8_2025!")
MASTER_SECRET = _secret_env.encode()

# ── URL du serveur — lire depuis variable d'environnement ou valeur par défaut
SERVER_URL = os.environ.get(
    "SERVER_URL",
    "https://opti-p8wu.onrender.com"
)
